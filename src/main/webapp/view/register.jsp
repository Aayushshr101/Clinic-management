    ...
    <style>
        ...
        * {
        ...
        .login-form-content p {
            /* Targeting paragraphs inside the form content */
            font-size: 0.95rem;
            color: #6c757d;
            margin-top: 20px;
        }
        ...
        .login-form-content p a {
            /* Targeting links inside the form content */
            color: #4a90e2;
            font-weight: 600;
...
<body class="login-page">
    ...
    <div class="main-login-wrapper">
        <div class="login-image-section">
            <!-- Placeholder for a relevant registration image -->
            <img src="https://media.istockphoto.com/id/487728499/photo/healthcare-worker-with-a-patient.jpg?s=612x612&w=0&k=20&c=siUqjm4AJjm685DhsatuoeOBGavIJApAR1mhMBteysk=" alt="Patent" class="doctor-image" />
        </div>
